...
public class Main {
	...
	private static void login() {
		...
		for (int i = 0; i < 5; i++) {
			...
			/*
			 * ¾ÆÀÌµğ ºñ¹ø ´Ğ³×ÀÓ 'id1', '123123' '¹ÚÆò½ÄÀÇ5Á¡' 'my123',, '1q2w3e4r' '¿ìÁÖ¸íÀÛ7±¤±¸'
			 * 'bonglove','bong123' 'ºÀÁØÈ£»ç¶ûÇØ' 'kimchi12' 'kimchi12' 'kimchi12' 'gogo0325'
			 * '123123' '¿µÈ­ÇĞ»ìÀÚ'
			 */
	...
	private static void update_review() {
		...
		System.out.println("¼öÁ¤ÇÒ ¸®ºäÀÇ ¹øÈ£¸¦ ÀÔ·ÂÇÏ¼¼¿ä");
		int geulno = sc.nextInt();
		sc.nextLine();
	...
	private static void review_disp(int movieNo) {
		...
		while (true) {
			...
			// ÀÎÀÚ·Î ¹ŞÀº ¹«ºñ³Ñ¹ö¿Í °°Àº ¸®ºä ·¹ÄÚµå Á¶È¸ÇÏ±â
