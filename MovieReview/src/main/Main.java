		...
		for (int i = 1; i <= 5; i++) {
			...
			while (count<5) {
				...
				if (!pwd_check.equals(vo.getPassword())) {
					...
					count++;
					System.out.printf("ºñ¹Ğ¹øÈ£ ÀÔ·Â ½ÇÆĞ %dÈ¸!! \n",count);
...
//			}
	...
	private static void main_main1_1_disp() {
		...
		while (true) {
			...
			System.out.println("[8] ÀüÃ¼ ¸®ºä Á¶È¸ÇÏ±â");
	...
	private static void main_main_disp(int cateno) {
		...
		while (true) {
			...
			System.out.println("ÀÌÀü È­¸éÀ¸·Î µ¹¾Æ°¡½Ã·Á¸é 'n'À» ÀÔ·ÂÇÏ¼¼¿ä.");
			...
			//¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú¡ÚÀß¸ø ÀÔ·ÂÇÑ °æ¿ì¿Í ³ª°¡´Â °æ¿ì¸¦ ±¸ºĞÇØ¼­ ±¸Çö¡Ú¡Ú¡Ú¡Ú¡Ú¡Ú
			...
			String res = sc.nextLine();
				...
				if (movie_list2.contains(res)) {
					...
					System.out.println("Àå¸£¿¡ Æ÷ÇÔµÇÁö ¾ÊÀº ¿µÈ­ÀÔ´Ï´Ù, ´Ù½Ã ÀÔ·ÂÇØÁÖ¼¼¿ä.");
					continue;
				}
...
//	}
	...
	// Àå¸£¸¦ ¼±ÅÃÇÏ°í ¿µÈ­¸¦ °í¸¥ ÈÄ¿¡ ¸®ºä ÀÛ¼ºÇØ¼­ »ğÀÔÇÏ´Â ºÎºĞ
